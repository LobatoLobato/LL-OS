...
x86_64_cpp_object_files := $(patsubst src/x86_64/%.cpp, build/x86_64/%.o, $(x86_64_cpp_source_files))
...
$(x86_64_cpp_object_files): build/x86_64/%.o : src/x86_64/%.cpp
	mkdir -p $(dir $@) && \
	x86_64-elf-gcc -c -I src/interfaces -ffreestanding $(patsubst build/x86_64/%.o, src/x86_64/%.cpp, $@) -o $@
...
$(kernel_cpp_object_files): build/kernel/%.o : src/kernel/%.cpp
	mkdir -p $(dir $@) && \
	x86_64-elf-gcc -c -I src/interfaces -ffreestanding $(patsubst build/kernel/%.o, src/kernel/%.cpp, $@) -o $@
